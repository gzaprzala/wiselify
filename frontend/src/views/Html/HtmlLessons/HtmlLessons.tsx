...
const saveResults = `${import.meta.env.VITE_BACKEND_URL}api/v1/results/html`;
...
const HtmlLessons = () => {
  ...
  const calculateSummaryPoints = () => {
    ...
    points += selectedAnswers[1] === 'answer2a' ? 1 : 0;
        ...
        lessons[currentLessonIndex].subject === 'Html' && (
          <div className={style['htmllessons-content']} key={lesson.id}>
            <div className={style['htmllessons-content-upper']}>
              ...
              <div className={style['htmllessons-content-upper-text']}>
                ...
                {lessons[currentLessonIndex].id !==
                  ...
                  <span className={style['htmllessons-span']}>
                    Lekcja {lessons[currentLessonIndex].id - 3 * lessons.length}
                  </span>
                )}
                {lessons[currentLessonIndex].id ===
                  lessons[lessons.length - 1].id && (
            ...
            <div className={style['htmllessons-main']}>
              ...
              {lessons[currentLessonIndex].id ===
                lessons[lessons.length - 1].id && (
                <div className={style['htmllessons-test']}>
                  <div className={style['htmllessons-answers']}>
                    <div className={style['htmllessons-answer']}>
                      <p className={style['htmllessons-number']}>1.</p>
                      <input
                        type='radio'
                        name='answer1'
                        value='answer1a'
                    ...
                    <div className={style['htmllessons-answer']}>
                      <p className={style['htmllessons-number']}>2.</p>
                      <input
                        type='radio'
                        name='answer2'
                        value='answer2a'
                    ...
                    <div className={style['htmllessons-answer']}>
                      <p className={style['htmllessons-number']}>3.</p>
                      <input
                        type='radio'
                        name='answer3'
                        value='answer3a'
                    ...
                    <div className={style['htmllessons-answer']}>
                      <p className={style['htmllessons-number']}>4.</p>
                      <input
                        type='radio'
                        name='answer4'
                        value='answer4a'
                    ...
                    <div className={style['htmllessons-answer']}>
                      <p className={style['htmllessons-number']}>5.</p>
                      <input
                        type='radio'
                        name='answer5'
                        value='answer5a'
                    ...
                    <button
                      className={style['htmllessons-submit']}
                      onClick={handleSubmit}>
                      Submit
                    </button>
                  </div>
                  <div className={style['htmllessons-score']}>
                    {results && (
                      <span>Twój ostatni wynik: {results.htmlTestResult}</span>
                    )}
                  </div>
                </div>
              )}
